...
(function () {
  ...
  .controller('kitchSinkcontroller', KitchSinkController);

    KitchSinkController.$inject = ['$baseController','moment','calendarConfig', '$userEventsService', '$scope'];
  
  
    function KitchSinkController(
        $baseController
        ,moment
        ,calendarConfig
        ,$userEventsService
